...
//		java의 기본제공 package중에서 많이 쓰이는 utill package, 유용한 class를 많이 가지고 있다
...
//		Collection Framwork에서 가장 기본이 되는 인터페이스
...
//		utill package에는 위에서 설명한 interface를 구현하고 있는 class들을 많이 가지고 있다
